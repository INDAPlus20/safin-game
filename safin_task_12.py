...
def game(mode):
    ...
    def ballMovement():
        ...
        if ballPos.left <= 0:
            ...
            playerPoints += 1
            playerPos.center = (screenWidth - 20, screenHeight / 2)
            AIPos.center = (20, screenHeight / 2)
        ...
        if ballPos.colliderect(playerPos) and ballSpeedX > 0:
            ...
            if abs(ballPos.right - playerPos.left) < 10:
                ballSpeedX *= -1
        ...
        if ballPos.colliderect(AIPos) and ballSpeedX < 0:
            ...
            if abs(ballPos.left - AIPos.right) < 10:
                ballSpeedX *= -1
    ...
    while runGame:
        ...
        screen.blit(playerScoreText, (600, 500))
        enemyScoreText = scoreFont.render(f'{AIPoints}', True, black)
        screen.blit(enemyScoreText, (200, 500))
